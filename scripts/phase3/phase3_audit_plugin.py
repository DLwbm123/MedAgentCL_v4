...
OUTPUT = Path(os.environ.get("PHASE3_OUTPUT_DIR", "/root/MedAgentCL_v4/output/phase3_native_lora"))
...
class Phase3AuditCallback(TrainerCallback):
    ...
    def on_train_end(self, args, state, control, model=None, **kwargs):
        ...
        summary = {
            "status": "PASS" if len(records) == 10 and q_changed and v_changed else "BLOCKED",
...
callbacks_map["phase3_audit"] = Phase3AuditCallback
