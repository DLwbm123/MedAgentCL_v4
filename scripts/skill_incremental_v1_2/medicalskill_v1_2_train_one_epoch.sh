...
OUT=${MEDICALSKILL_V1_2_OUTPUT_ROOT:-$ROOT/output/MedicalSkill-CL-v1.2}
...
task_id=${1:?Usage: medicalskill_v1_2_train_one_epoch.sh TASK_ID}
name=${TASKS[$task_id]:-}
[[ -n "$name" ]] || { printf 'Invalid task id: %s\n' "$task_id" >&2; exit 2; }
